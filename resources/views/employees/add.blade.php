                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="first-name" name="first_name" aria-describedby="firstNameError" value="{{ old('first_name') }}">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="last-name" name="last_name" aria-describedby="lastNameError" value="{{ old('last_name') }}">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="birthday" name="birthdate" max="{{ date('Y-m-d', strtotime('now')) }}" aria-describedby="birthdayError" value="{{ old('birthdate') }}">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="monthly-salary" name="monthly_salary" aria-describedby="monthlySalaryError" value="{{ old('monthly_salary') }}">
                                    </div>
